...
export class createAllTables1632667825286 implements MigrationInterface {
    name = 'createAllTables1632667825286'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "client_id" uuid NOT NULL, "client_secret" text NOT NULL, "data_uris" text NOT NULL, "grants" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "authorization_codes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "authorization_code" text NOT NULL, "expires_at" TIMESTAMP NOT NULL, "redirect_uri" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "client_id" uuid, "user_id" uuid, CONSTRAINT "PK_f05b2eb99ad2db12d87544656c4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tokes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "access_token" text NOT NULL, "access_token_expires_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "client_id" uuid, "user_id" uuid, CONSTRAINT "PK_ba2a8afaa446dc4119c6fd35ba0" PRIMARY KEY ("id"))`);
